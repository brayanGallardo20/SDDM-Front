    ...
    template: `
          <ng-container>
             ...
             <a (click)="itemClick($event)" (mouseenter)="onMouseEnter()" *ngIf="(item.routerLink && !item.items) && item.visible !== false"
                  ...
                  <span class="menuitem-text">{{item.label}}</span>
                  <i cla ss="pi pi-fw pi-angle-down layout-submenu-toggler" *ngIf="item.items"></i>
                  <i [ngClass]="item.icon" class="layout-menuitem-icon"></i>
              </a>
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public appMain: PagesComponent, public router: Router, private cd: ChangeDetectorRef,private menuService : MenuService) {
